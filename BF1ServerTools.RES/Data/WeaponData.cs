...
public static class WeaponData
{
    ...
    public readonly static List<WeaponName> AllWeaponInfo = new()
    {
        ...
        new WeaponName(){ Kind="坦克", English="ID_P_VNAME_ASSAULTTRUCK", Chinese="朴帝洛夫·加福德", ShortName="ASSAULTTRUCK", ImageName="PutilovGarford-20a4fd91.png" },
        new WeaponName(){ Kind="突袭装甲车1", English="U_RU_PutilovGarford_Package_AssaultGun", Chinese="突击装甲车", ShortName="ATTruck TX", ImageName="PutilovGarford-20a4fd91.png" },
...
new WeaponName() { Kind="近战武器", English="U_Shovel", Chinese="军铲", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_TrenchMace", Chinese="战壕槌", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_SawtoothKnife", Chinese="锯齿刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_Club", Chinese="棍棒", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_AmericanTrenchKnife", Chinese="小型战壕刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_KnifeTrench", Chinese="战壕刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_BoloKnife", Chinese="地狱战士双刃短刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_USTrenchKnife1917", Chinese="美军战壕刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_BeduinDagger", Chinese="贝都因匕首", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_JambiyaKnife", Chinese="双刃弯刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_SpikedClub", Chinese="狼牙棒", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_BayonetCharge", Chinese="刺刀衝锋", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_Hatchet", Chinese="手斧", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_BartekBludgeon", Chinese="鲍尔泰克巨木棒", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_Saber_Cav", Chinese="骑兵军刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_ScoutKnifeM1916", Chinese="野战刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_ScoutKnife", Chinese="求生小刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_Pickaxe", Chinese="鹤嘴锄", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_Frenchnail", Chinese="铁钉小刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_RoyalSabre", Chinese="军刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_TrenchFleur", Chinese="战壕鸢尾刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_RoyalClub", Chinese="奇兵棒", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_BIllhook", Chinese="钩镰", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_TankerClub", Chinese="齿轮槌", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_Kukri", Chinese="反曲刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_ArditiDaggerNew", Chinese="敢死队匕首", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_Lance_Cav", Chinese="骑兵长枪", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_CossackDagger", Chinese="哥萨克匕首", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_GrenadeClub", Chinese="哑弹棒", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_Totokia", Chinese="鸟嘴槌", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_HuntingKnife", Chinese="法军屠刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_RussianCombatKnife", Chinese="俄军勳刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_CoupeCoupe", Chinese="开山刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_RussianAxe", Chinese="俄军战斧", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_NavalCutlass", Chinese="海军弯刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_MarineHook", Chinese="勾索", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_OttomanFlangedMace", Chinese="鄂图曼钉头锤", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_SpikedClubBarbedWire", Chinese="铁丝木棒", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_Ararebo", Chinese="金碎棒", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_KilijSabre", Chinese="鄂图曼弯刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_Yatagan", Chinese="穆斯林弯刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_MeatCleaver", Chinese="切肉刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_Prybar", Chinese="撬棍", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_BrokenBottle", Chinese="碎酒瓶", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_Bottle", Chinese="酒瓶", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_Sickle", Chinese="镰刀", ShortName="", ImageName="" },
new WeaponName() { Kind="近战武器", English="U_WelshBlade", Chinese="威尔士刀", ShortName="", ImageName="" },
